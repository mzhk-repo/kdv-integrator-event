...
from .config import INTEGRATOR_MOUNT_PATH, FOLDER_PROCESSED, FOLDER_ERROR, DSPACE_UI_URL
...
def run_dspace_workflow(biblionumber, file_path, meta, koha_client=None, dspace_client=None):
...
def process_integration_logic(task_id, biblionumber, koha_client=None, dspace_client=None):
    ...
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
            ...
            # Task B: DSpace
            future_dspace = executor.submit(run_dspace_workflow, biblionumber, current_active_path, meta, koha_client=koha, dspace_client=dspace_client)
