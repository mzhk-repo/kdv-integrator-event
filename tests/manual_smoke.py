...
# test parse_marc
print("parse_marc_details output", parse_marc_details('<record><datafield tag="245" ind1=" " ind2=" "><subfield code="a">Title</subfield></datafield></record>'))

# test run_dspace_workflow
print(run_dspace_workflow(1, "/tmp/fake.pdf", {"collection_uuid": "col"}, koha_client=StubKoha(), dspace_client=StubDSpace()))

# test process_integration_logic with missing file should set error and raise
try:
    process_integration_logic("task1", 1, koha_client=StubKoha(), dspace_client=StubDSpace())
